 ...
 * Available methods:
 *   - jwtUtils.generateJwtToken(data, algorithm, params);
 * See below for documentation of particular method.
 */
pm.globals.set('jwtUtils', function loadJwtUtils() {
   ...
   *
   * @param data JWT data
   * @param algorithm encoding algorithm to use to sign token. Available algoritms are listed in {@code ENCODERS}
   * @param algorithmParams parameters required for encoding, e.g. secret for HmacSHA
